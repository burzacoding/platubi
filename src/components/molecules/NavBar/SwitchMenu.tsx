...
const SwitchMenu = forwardRef<SVGSVGElement, SwitchMenuProps>(({open, setToggle}, ref) => {
  const toggleMenuFunc = () => {
    setToggle(t => !t)
  }
  return (
    <div className="">
        <MenuSvg  width="32" height="24" viewBox="0 0 28 24" fill="none" xmlns="http://www.w3.org/2000/svg" onClick={toggleMenuFunc} id="mysvg" ref={ref}>
        <g id="hamb">
