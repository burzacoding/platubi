      ...
      <ArticleContainer>
        <MainContent>
          ...
          <Article id="tyc">
            ...
            <P>Esta web NO contiene enlaces a terceros, a excepción de enlaces que dirigen al perfil de de github del creador de Platubi solamente con fines de promoción personal.</P>
